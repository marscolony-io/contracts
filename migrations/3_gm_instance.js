...
module.exports = async (deployer, network, addresses) => {
  ...
  // // const sm = await SalesManager.deployed();
  ...
  // await gm.setClnyPerSecond(ether('100000').div(new BN((24 * 60 * 60).toString())))
  // await gm.updatePool(await gm.CLNYAddress())
  // await gm.setTotalShareFromTotalSupply();
  // console.log(+await gm.totalShare())
  // await gm.startShareSystem(1653403273);
  // const ids = await mc.allTokensPaginate(60, 80);
  // console.log(ids.map(o=>+o));
  // const tx = await gm.setBackendSigner('0xfbfe71afec1b7eb860542111b7a2ce5afaa2c11f');
  // console.log({ tx });
